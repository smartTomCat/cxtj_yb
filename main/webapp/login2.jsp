...
<head>
    ...
    <script src="loginSRC/js/indexBg.js" type="text/javascript"></script>
...
<img id="bgimgimg" src="${pageContext.servletContext.contextPath }/loginSRC/img/bg.png">
<canvas id="index_bg_canvas" class="canvas">您的浏览器不支持canvas标签</canvas>
<div class="top-title">
    <div class="logo"></div>
    <span><%= SysConfig.getSysConfig("applicationDesc")%></span>
</div>
<div class="container">
    <!-- top start -->
    <!--
        ...
        <div class="loginFormPL">
            ...
            <div class="loginform">
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td id="validate"
                            class="validate">${sessionScope['SPRING_SECURITY_LAST_EXCEPTION'].message} </td>
                    </tr>
                    <tr>
                    ...
                    <tr style="display: none;" id="checkCodeDiv">
                        <td><input type="text" id="checkCode"
                            ...
                            <a href="#"><img id="codeimg"
                                             ...
                                             title="点击获取验证码"
                                             style="float:left;width:95px;height:36px;margin-left:12px;border:1px solid #dcdcdc;"/></a>
                        </td>
                    </tr>
                    <%}%>
                    ...
                    <tr>
                        <td style="text-align:right;" class="topsdmodify">
