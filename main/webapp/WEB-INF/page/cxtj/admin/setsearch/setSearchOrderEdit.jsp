	    	...
	    	<ta:box cols="5">
	    		<ta:panel key="待选项目" span="2">
	    			<ta:box cols="3">
	    				...
	    				<ta:buttonLayout span="0.6" align="left">
	    					<ta:button key="查询" onClick="fnQuery1()"/>
	    				</ta:buttonLayout>
	    			</ta:box>
			    	<ta:datagrid id="grid1" forceFitColumns="true" height="365px" selectType="checkbox" onSelectChange="fnShowBtn">
		    			<ta:datagridItem id="yzb620" hiddenColumn="true"/>
		    			<ta:datagridItem id="yzb621" key="排序号" showDetailed="true" align="center" dataAlign="center" width="60"/>
		    			<ta:datagridItem id="yzb623" key="数据库字段或表达式" showDetailed="true" align="center" dataAlign="center" width="150"/>
		    			<ta:datagridItem id="yzb624" key="数据库字段AS别名" showDetailed="true" align="center" dataAlign="center" width="150"/>
		    	...
		    	<ta:panel key="已选项目" span="2.6">
		    		<ta:box cols="3">
	    				...
	    				<ta:buttonLayout span="0.6" align="left">
	    					<ta:button key="查询" onClick="fnQuery2()"/>
	    				</ta:buttonLayout>
	    			</ta:box>
			    	<ta:datagrid id="grid2" forceFitColumns="true" height="365px" selectType="checkbox" onSelectChange="fnShowBtn">
		    			<ta:datagridItem id="yzb650" hiddenColumn="true"/>
		    			<ta:datagridItem id="yzb651" key="排序号" formatter="fnFormatterYzb651" showDetailed="true" align="center" dataAlign="center" width="80"/>
		    			<ta:datagridItem id="yzb652" key="排序方式" formatter="fnFormatterYzb652" showDetailed="true" align="center" dataAlign="center" width="100"/>
		    			<ta:datagridItem id="yzb623" key="数据库字段或表达式" showDetailed="true" align="center" dataAlign="center" width="150"/>
		    			<ta:datagridItem id="yzb624" key="数据库字段AS别名" showDetailed="true" align="center" dataAlign="center" width="150"/>
		    			<ta:datagridItem id="yzb625" key="数据库字段中文" showDetailed="true" align="center" dataAlign="center" width="100"/>
		    		</ta:datagrid>
