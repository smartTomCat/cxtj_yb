...
//                            }));
		   ...
		   <span id='nrz_span_id' style='display:inline;width:98%;'>
		     ...
		     <input name='vtype' value='1' type='hidden'/>
                    ...
                    <tr>
                        <td style="width:30px;text-align: left;" colspan="4">
                            <ta:button key="增加条件" onClick="addCondition(this)" cssClass="btnadd"/>
                            <ta:button key="删除该条件组" onClick="deleteCondition(this)" cssClass="btnmdelete"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <ta:box cols="6" cssStyle="">
        ...
        <ta:box span="2" cssStyle="margin-left:-20px;">
            <ta:button key="&nbsp;&nbsp;&nbsp;&nbsp;统&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计&nbsp;&nbsp;&nbsp;&nbsp;"
...
<!-- 统计信息结果datagrid -->
<ta:fieldset id="statisticalInfoId" key="<h2 style=padding:0px;font-size:16px;margin-right:8px;font-weight:bold;>统计结果</h2><span style=color:red;>(鼠标点击统计值，可反查明细)</span>" cssStyle="">
...
<div id="deailInfoId" layout="column">
    <div class="tafieldset_header" style="background-color: white;margin-top: 6px;">
        <div class="header-bg"></div>
...
//                }));
            ...
            var _url = "${basePath}/query/customizeQueryAction!queryPage.do";
            Base.submit("queryResultDgd", _url, {'dto.xml': xml,'dto.yzb612': yzb612,'dto.yzb711': tjfaname,'dto.yzb670': yzb670}, null, null, function (data) {
