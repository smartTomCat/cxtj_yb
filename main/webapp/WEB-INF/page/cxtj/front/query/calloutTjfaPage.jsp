...
<ta:form id="frm" fit="true">
    <ta:panel id="pnl1" fit="true" cols="2">
        ...
        <ta:datagrid id="grid" fit="true" heightDiff="20" forceFitColumns="true" haveSn="true" selectType="radio"
                     span="2">
            <ta:datagridItem id="yzb711" key="统计方案名称"/>
            <ta:datagridItem id="aae036" key="保存时间"/>
            <ta:dataGridToolPaging url="customizeQueryAction!getTjfaInfo.do" pageSize="20" showCount="true"
                                   submitIds="frm"/>
        </ta:datagrid>
        <ta:buttonGroup id="btnlyt5" span="2" align="center" cssStyle="margin-top:-5px">
            <ta:button id="btnOK" key="确定" onClick="fnCalloutTjfa()" space="true" cssClass="btnmodify"/>
