...
import com.yinhai.cxtj.front.service.OracleCustomizeQueryService;
 ...
 */
public class OracleCustomizeQueryServiceImpl extends CommonCustomizeQueryServiceImpl implements OracleCustomizeQueryService {
    ...
    public Map getPageStatisticalData(TaParamDto para) throws Exception {
        ...
        if(ValidateUtil.isNotEmpty((String)outmap.get("msg"))){//有错误消息
            ...
            outputDomain.put("appMsg", String.valueOf(outmap.get("msg")));
            return outputDomain;
        }
